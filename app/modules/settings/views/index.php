...
$clear_log_days    = $result->clear_log_days;
                        ...
                        <div class="col-sm-12 mb0">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home_with_icon_title">
                                    ...
                                    <b>Chave da API do Google Maps (<a href="https://youtu.be/zWoS6CC9rjo" target="_blank">Video Explicativo</a>)</b>
                                    <div class="form-group">
                                    ...
                                    <b>Limpar o log do histórico de tarefas (exceto comentário, repostagem)</b>
                                    <div class="form-group">
                                        <select name="clear_log_days" class="form-control">
                                            <option value="0">---------</option>
                                            <?php for ($i = 1; $i <= 31; $i++) {
                                            ?>
                                                <option value="<?=$i?>" <?=$i==$clear_log_days?"selected":""?>><?=$i." ".l('days')?></option>
                                            <?php } ?>
                                        </select>
                                        <?=l("Recommended 3~5 days")?>
                                    </div>
